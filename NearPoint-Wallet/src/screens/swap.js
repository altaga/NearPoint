...
import { geckoNative, geckoTokens, NODE_ENV_RCP, NODE_ENV_CHAINLINK_FEED_CONTRACT, tokens, contentColor } from "../../env"
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(value) => {
                                        if (value === "") {
                                            ...
                                            this.mount && this.setState({
                                                from: value,
                                                to: this.state.flag ? parseFloat(value) * this.context.value.tokenUSD["AURORA"] : epsilonRound(parseFloat(value) / this.context.value.tokenUSD["AURORA"] ?? 1, 2)
                                            })
                                        }
                                    }}
                                />
