        ...
        return (
            <View style={GlobalStyles.containerSetup}>
                ...
                }
                {
                    this.state.stage === 0 &&
                    <>
                        <Image source={logoETH} style={{ height: 556 / 2, width: 746 / 2 }} />
                    </>
                }
                {
                    this.state.stage === 1 &&
                    <>
                        ...
                        <Image source={logoETH} style={{ height: 556 / 2.5, width: 746 / 2.5 }} />
                ...
                }
                {
                    ...
                    <>
                        ...
                        <View style={{ borderBottomWidth: 2, borderColor: contentColor, width: "100%" }} />
                        <ScrollView style={{ width: "100%" }}>
                            <View style={{ flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                                ...
                                <TextInput
                                    style={{ fontSize: 22, textAlign: "center", borderRadius: 6, backgroundColor: 'white', color: "black", width: "90%", borderWidth: 1, borderColor: contentColor, marginTop: 10 }}
                                ...
                                />
                                <View style={{ borderBottomWidth: 2, borderColor: contentColor, width: "90%", alignSelf: "center", marginVertical: 20 }} />
                                ...
                                <View style={{ flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", marginTop: 10 }}>
                                    <TextInput
                                        ...
                                        style={{ fontSize: 22, textAlign: "center", borderRadius: 6, backgroundColor: 'white', color: "black", width: "74%", borderWidth: 1, borderColor: contentColor, marginRight: "4%" }}
                                ...
                                <View style={{ width: "90%" }}>
                                    <Picker
                                        buttonStyle={{ fontSize: 22, textAlign: "center", borderWidth: 1, borderColor: "black", borderWidth: 1, borderColor: contentColor, borderRadius: 6, marginTop: 10 }}
                                ...
                                <View style={{ flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", width: "90%" }}>
                                    ...
                                    <TextInput
                                        style={{ fontSize: 22, textAlign: "center", borderRadius: 6, backgroundColor: 'white', color: "black", width: "80%", borderWidth: 1, borderColor: contentColor }}
                                        keyboardType="decimal-pad"
